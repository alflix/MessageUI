...
open class ChatCollectionView: UICollectionView {
    // MARK: - Properties
    ...
    open weak var messageCellDelegate: ChatCellDelegate?
    ...
    private func registerReusableViews() {
        register(TextChatCell.self)
        register(MediaChatCell.self)
        register(AudioChatCell.self)
        register(LocationChatCell.self)
