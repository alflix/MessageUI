...
extension SegementSlideViewController {
    internal func setup() {
        ...
        observewillClearAllReusableViewControllers()
    }
    ...
    private func observeScrollViewContentOffset() {
        parentKeyValueObservation = segementSlideScrollView.observe(\.contentOffset,
    ...
    private func observewillClearAllReusableViewControllers() {
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(willClearAllReusableViewControllers(_:)),
                                               name: SegementSlideContentView.willClearAllReusableViewControllers,
                                               object: nil)
    }
    ...
    internal func layoutSegementSlideScrollView() {
        let topLayoutLength: CGFloat = edgesForExtendedLayout.contains(.top) ? 0 : self.topLayoutLength
        layoutSegementSlideHeaderView()
        layoutSegementSlideSwitcherView()
        layoutSegementSlideContentView()
    ...
    internal func layoutSegementSlideHeaderView() {
        let topLayoutLength: CGFloat = edgesForExtendedLayout.contains(.top) ? 0 : self.topLayoutLength
    ...
    internal func layoutSegementSlideSwitcherView() {
    ...
    internal func layoutSegementSlideContentView() {
