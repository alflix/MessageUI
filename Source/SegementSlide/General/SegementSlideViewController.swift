...
open class SegementSlideViewController: UIViewController {
    ...
    public var currentContentViewController: SegementSlideContentScrollViewDelegate? {
    ...
    deinit {
        ...
        NotificationCenter.default.removeObserver(self, name: SegementSlideContentView.willClearAllReusableViewControllers, object: nil)
        #if DEBUG
