...
public class SegementSlideContentView: UIView {
    internal static let willClearAllReusableViewControllers: NSNotification.Name
        = NSNotification.Name(rawValue: "willClearAllReusableViewControllers")
...
extension SegementSlideContentView {
    ...
    private func clearAllReusableViewControllers() {
        NotificationCenter.default.post(name: SegementSlideContentView.willClearAllReusableViewControllers, object: viewController, userInfo: nil)
