...
public extension UIScrollView {
    ...
    func configAssociatedObject(object: AnyObject) {
        guard objc_getAssociatedObject(object, &AssociatedObject.key) == nil else { return }
...
public extension UIScrollView {
    ...
    var footerAlwaysAtBottom: Bool {
        get {
            ...
            guard let footerContainer = self.viewWithTag(PullToRefreshKitConst.footerTag) as? RefreshFooterContainer else { return }
